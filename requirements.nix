...
#
# COMMAND:
#   pypi2nix --python-version python36 -r requirements.txt -E postgresql
#
...
let
  ...
  generated = self: {
    "atomize" = python.mkDerivation {
      name = "atomize-0.2.0";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/e3/8a/60c7dbcca21c51dff6df932a10c4b2d453ea474428c64021dd5ba609f8d5/atomize-0.2.0.tar.gz";
        sha256 = "93791ce9d4087223f1a3a59f98aa0134e9281407ce4cb1bd5489c0fd41e4ef64";
};
    ...
    "cherrypy" = python.mkDerivation {
      name = "cherrypy-7.1.0";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/ae/0a/1e47566e3e63142f1c676221f0e9ce41d4045773af98cb6b206b366702cc/CherryPy-7.1.0.tar.gz";
    ...
    "sqlalchemy" = python.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/aa/cb/e3990b9da48facbe48b80a281a51fb925ff84aaaca44d368d658b0160fcf/SQLAlchemy-1.0.14.tar.gz";
    ...
    "textile" = python.mkDerivation {
      name = "textile-2.3.16";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/1e/e1/41d080eb133547a1a5ca984e1db11d014ea4524d4fa879f3222dcf9fc533/textile-2.3.16.tar.gz";
        sha256 = "6f151c1a4119fc5f795b59efdb4a35998718b1a55c2d882e54785a189cfb5907";
};
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs ++ [ ];
      propagatedBuildInputs = [
